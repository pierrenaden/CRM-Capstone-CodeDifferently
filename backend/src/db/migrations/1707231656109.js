module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('notes', 'date', { transaction });

      await queryInterface.removeColumn('notes', 'content', { transaction });

      await queryInterface.removeColumn('metrics', 'related_userId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('activities', 'assigned_userId', {
        transaction,
      });
